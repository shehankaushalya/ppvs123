            ...
            <div class="sparkline13-hd">
                ...
                <div class="row" style="margin-top: 100px">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <h3 style="color:#337ab7;">Location</h3>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    ...
                    <?php
                            if ($project_location_fetch_data->num_rows() > 0) {
                                ...
                                <?php if ($row->UserName == $this->session->userdata('username')) { ?>
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <a class="btn btn-primary btn-block btn-lg" href="../Home/ImageView" role="button">
                                    <?php echo $row->LocationCode  ?> 
                                    </a>
                                    </div>
                                    <br>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><?php echo $row->Status  ?></div>
