                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <select class="js-example-basic-multiple"
                                        ...
                                        onchange="document.getElementById('D_E_ProjectName').value=this.options[this.selectedIndex].text; document.getElementById('idValue').value=this.options[this.selectedIndex].value;"
                                        required>
                                    ...
                                    <input class="form-control" name="ProjectCode" id="D_E_ProjectName"
