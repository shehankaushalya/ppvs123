        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    ...
                    <form method="post" action="../Location/updatedata" class="locationE_Edit">
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" class="form-control" id="E_E_LocationCode" name="LocationCode"
                                        readonly />
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <select class="js-example-basic-multiple" name="Project"
                                        ...
                                        onchange="document.getElementById('E_E_ProjectName').value=this.options[this.selectedIndex].text; document.getElementById('idValue').value=this.options[this.selectedIndex].value;">
                                    ...
                                    <input class="form-control" name="ProjectCode" id="E_E_ProjectName"
