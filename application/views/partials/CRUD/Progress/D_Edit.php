        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    ...
                    <form method="post" action="../Progress/updatedata" class="progressD_Edit">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <input type="hidden" class="form-control" 
                                        name="PpdCode" id="D_E_PpdCode" readonly />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <select class="js-example-basic-multiple"
                                        ...
                                        onchange="document.getElementById('D_E_ProjectCode').value=this.options[this.selectedIndex].text; document.getElementById('idValue').value=this.options[this.selectedIndex].value;"
                                        required>
                                    ...
                                    <input class="form-control" name="ProjectCode" id="D_E_ProjectCode" 
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <select class="js-example-basic-multiple"
                                        style="color:#337ab7; border:1px solid #ddd;"
                                        onchange="document.getElementById('D_E_LocationCode').value=this.options[this.selectedIndex].text; document.getElementById('idValue').value=this.options[this.selectedIndex].value;"
                                        required>
                                        <option value="-1"></option>
                                    ...
                                    <input class="form-control" name="LocationCode" id="D_E_LocationCode" 
                                    style="position:absolute;top:0px;width:240px;width:180px\9;#width:180px; border:1px solid #ddd; border-right:0;" 
                                    onfocus="this.select()" type="text" readonly required>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <select class="js-example-basic-multiple" style="color:#337ab7; border:1px solid #ddd;" 
                                    onchange="document.getElementById('D_E_PhotoItem').value=this.options[this.selectedIndex].text; 
                                    document.getElementById('idValue').value=this.options[this.selectedIndex].value;">
                                        <option value="-1"></option>
                                        <option>Bridge
                                                                                             </option>
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" class="form-control" id="D_E_ImgDate" name="ImgDate" readonly/>
