                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="hidden" class="form-control"
                                    name="PpdCode" id="D_D_PpdCode" readonly />
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="hidden" class="form-control" placeholder="Enter Image Link" id="D_D_Image" name="Image"
                                    readonly />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="text" class="form-control" placeholder="Enter Photo Capturing Date" id="D_D_ImgDate" name="ImgDate"
                                    readonly />
                            </div>
                        </div>
                    </div>
