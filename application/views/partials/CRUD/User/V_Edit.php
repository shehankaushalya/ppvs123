        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    ...
                    <form method="post" action="../User/updatedata" class="userV_Edit">
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" class="form-control" name="UserName" id="V_E_UserName"
                                        readonly />
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <select class="form-control" style="color:#337ab7; border:1px solid #ddd;"
                                        onchange="document.getElementById('V_E_Position').value=this.options[this.selectedIndex].text; document.getElementById('idValue').value=this.options[this.selectedIndex].value;">
                                    ...
                                    <input class="form-control" name="Position" id="V_E_Position"
                        ...
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control" style="color:#337ab7; border:1px solid #ddd;"
                                        onchange="document.getElementById('V_E_Status').value=this.options[this.selectedIndex].text; document.getElementById('idValue').value=this.options[this.selectedIndex].value;">
                                        <option value="-1"></option>
                                        <option>ACTIVE
                                        </option>
                                        <option>BLOCK
                        ...
                        ?>
                        <input type="hidden" name="Status" id="V_E_Status">
                        <?php
                    }
                    ?>
                        <div class="form-group-inner">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Enter Contact Number"
                                        name="ContactNumber" id="V_E_ContactNumber" required />
                                </div>
                            </div>
                        </div>
