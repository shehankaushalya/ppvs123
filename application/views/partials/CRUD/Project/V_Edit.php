                ...
                <div class="row">
                    ...
                    <form method="post" action="../Project/updatedata" class="project_Edit">
                        ...
                        <!-- <div class="form-group-inner">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <label class="login2">Main Location</label>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Enter Main Location"
                                        name="MainLocation" id="V_E_MainLocation" required />
